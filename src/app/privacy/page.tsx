        ...
        sections={[
          {
            ...
            body: [
              ...
              'Your card, UPI and netbanking details are entered on PayU\u2019s secure page, not ours. They are never sent to or stored on our servers; we receive only a payment reference and the amount.',
            ],
          },
          {
          ...
          },
          {
            ...
            body: [
              'PayU, to process payment. Our email provider, to deliver transactional email. Our delivery partner, to ship your order. Nobody else — we do not sell data and we do not send marketing email.',
              'PayU is an Indian payment processor and payment data stays in India. Nothing you give us is transferred outside the country.',
            ],
          },
          {

      ...
      <LegalPage
        ...
        sections={[
          ...
          },
          {
            heading: 'Payment',
            body: [
              'Payments are processed by PayU — UPI, cards, netbanking and wallets. We never see or store your card, UPI or netbanking details. Your statement will show a charge from My Lucky Dates.',
            ],
          },
          {
